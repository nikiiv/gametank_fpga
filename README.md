...
**Status: M7 (cartridge) complete — `.gtr` games load via OSD/boot.rom into HPS DDR3, Flash2M banking, real SDK game runs on hardware; next up M8, compatibility & release.** See
